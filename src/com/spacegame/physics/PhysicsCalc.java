...
public class PhysicsCalc {
	...
	public static Vect2fPair getInelasticCollision(CollidableCircleModel c1, CollidableCircleModel c2, float elasticity) {
		...
		// TODO scale impulseMag in some way depending on the elastic coefficient
		Vector2f i1 = new Vector2f(impulseMag, 0);
		Vector2f i2 = new Vector2f(impulseMag, 0);
		i1 = Vector2f.scale(i1, -1.0f);
		i1 = Vector2f.rotate(i1, theta);
